...
```bash
/Users/clara/.claude/skills-venv/bin/python scripts/map_preflight.py dump    base.hwpx          # 키를 문서에서 뽑기
/Users/clara/.claude/skills-venv/bin/python scripts/map_preflight.py check   base.hwpx --map map.json
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py    replace  base.hwpx out.hwpx --map map.json
/Users/clara/.claude/skills-venv/bin/python scripts/map_preflight.py residue out.hwpx --against base.hwpx
```
...
```bash
/Users/clara/.claude/skills-venv/bin/python scripts/convert_hwp.py input.hwp -o output.hwpx
```
...
```bash
/Users/clara/.claude/skills-venv/bin/python scripts/html2hwpx.py input.html output.hwpx \
...
/Users/clara/.claude/skills-venv/bin/python scripts/gonmun.py --sample --output 기안문.hwpx

# JSON 입력으로 생성
/Users/clara/.claude/skills-venv/bin/python scripts/gonmun.py --input gonmun.json --output 기안문.hwpx

# 작성법 자동 검수 (날짜·시간·금액·붙임·물결표·외국어 병기 등)
/Users/clara/.claude/skills-venv/bin/python scripts/gonmun_lint.py --hwpx 기안문.hwpx --format text
```
...
/Users/clara/.claude/skills-venv/bin/python scripts/bodojaryo.py --sample --output 보도자료.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/bodojaryo.py --input bodo.json --output 보도자료.hwpx
```
...
/Users/clara/.claude/skills-venv/bin/python scripts/gyehoek.py --title "2026년 ○○ 추진계획" --date "2026. 1." --toc  --output 계획서.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/gyehoek.py --no-title --no-toc --output 계획서.hwpx
```
...
```bash
# 분석
/Users/clara/.claude/skills-venv/bin/python scripts/clone_form.py --analyze sample.hwpx

# 복제 + 텍스트 치환
/Users/clara/.claude/skills-venv/bin/python scripts/clone_form.py sample.hwpx output.hwpx --map replacements.json
/Users/clara/.claude/skills-venv/bin/python scripts/fix_namespaces.py output.hwpx
```
...
```bash
# 채울 수 있는 필드 분석
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py analyze form.hwpx

# values.json 예: {"성명": "홍길동", "연락처": "010-1234-5678"}
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py fill form.hwpx output.hwpx --values values.json

# 값 삽입과 비변경 엔트리 보존 검증
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py verify output.hwpx --values values.json --original form.hwpx

# 머리말·꼬리말·자동 쪽번호 사후 삽입/제거 (원본 보존, 중복 방지)
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-header doc.hwpx out.hwpx --text "대외주의" --align center
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-footer doc.hwpx out.hwpx --text "한국연구재단"
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-pagenum doc.hwpx out.hwpx --where footer --align center
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py remove-header doc.hwpx out.hwpx

# 표 구조/스타일 in-place (셀 배경/테두리·열추가·행삭제·셀병합)
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-cell doc.hwpx out.hwpx --table 0 --row 0 --col 1 --bg FFE600 --border on
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py merge-cells doc.hwpx out.hwpx --table 0 --row 0 --col 0 --row2 0 --col2 2

# 네이티브 수식 삽입 (문법: references/equation-syntax.md)
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py add-equation doc.hwpx out.hwpx --after "기준 문구" --script "x^2+y^2=z^2"

# 본문 글자/문단 서식 (굵게·색·크기·정렬·줄간격)
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-text-style doc.hwpx out.hwpx --after "제목 문구" --bold --color C00000 --size 16
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-para-style doc.hwpx out.hwpx --after "제목 문구" --align center --line-spacing 180

# 직인/서명 이미지(사용자 제공 PNG)를 기준 문구 위에 떠있게
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py place-seal doc.hwpx out.hwpx --image seal.png --anchor "발신명의" --size-mm 20
# 각주·하이퍼링크·책갈피 / 페이지·다단·쪽나누기 / 목록 / 차트
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py add-footnote doc.hwpx out.hwpx --after "본문" --text "각주"
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-page doc.hwpx out.hwpx --orientation landscape --margin-mm 15 --size a4
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-columns doc.hwpx out.hwpx --count 2 --gap-mm 8
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-bullet-list doc.hwpx out.hwpx --para 3 --to 6
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py insert-chart doc.hwpx out.hwpx --type col --cat cat.json --series series.json

# 문서 테마(제목색·표머리색 일괄) / 도형·글상자 / 이미지 편집
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py set-theme doc.hwpx out.hwpx --theme 남색
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py insert-textbox doc.hwpx out.hwpx --after "여기" --text "참고" --fill FFF2CC --rounding 24
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py list-images doc.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py resize-image doc.hwpx out.hwpx --index 0 --width-mm 30

# 개인정보(PII) 비경유 양식 채우기 — 값이 stdout/로그/모델 컨텍스트를 안 거침
/Users/clara/.claude/skills-venv/bin/python scripts/secure_fill.py fill form.hwpx out.hwpx --profile profile.json --shred-profile

# 한컴 열림 위험 신호까지 엄격 점검
/Users/clara/.claude/skills-venv/bin/python scripts/fill_hwpx.py check output.hwpx --strict
```
...
```bash
/Users/clara/.claude/skills-venv/bin/python scripts/fix_namespaces.py output.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/finalize_hwpx.py output.hwpx --strip-linesegarray --layout
/Users/clara/.claude/skills-venv/bin/python scripts/validate.py output.hwpx --layout

# Windows + Hancom Office only
/Users/clara/.claude/skills-venv/bin/python scripts/validate.py output.hwpx --hancom
```
...
```bash
/Users/clara/.claude/skills-venv/bin/python scripts/text_extract.py doc.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/text_extract.py doc.hwpx --format markdown
```

### 문제지 + 답안지 생성

```bash
/Users/clara/.claude/skills-venv/bin/python scripts/build_problem_answer_sheet.py \
  --input-json lesson.json \
  --output lesson-sheet.hwpx
/Users/clara/.claude/skills-venv/bin/python scripts/validate.py lesson-sheet.hwpx
```
